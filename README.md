...
This project was developed by Mohadikar Himesh Suresh as part of the B.E. Computer Engineering internship program at S.P.B. Patel Engineering College, Mehsana (Gujarat Technological University), in collaboration with Stark Technologies.
...
| 🛍 Recommendation System | Suggests relevant products to customers |
...
| 🗺 Logistics Analysis | Evaluates weather, distance, and routing impact |
...
Internal Guide: Prof. Shubhangi Chaturvedi

---

## 🙏 Acknowledgements

Special thanks to Stark Technologies and supervisor Mr. Sumit Chawla for mentorship and industry exposure, and to Prof. Shubhangi Chaturvedi and HOD Prof. Akshay Kansara at S.P.B. Patel Engineering College for their academic guidance.
